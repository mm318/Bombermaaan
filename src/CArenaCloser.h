...
struct TClosure
{
    SClosePosition positions[ARENA_WIDTH * ARENA_HEIGHT];
    int start;
    int end;
    ...
    void push_back(SClosePosition position)
    {
        if (end < ARENA_WIDTH * ARENA_HEIGHT)
        {
    ...
    SClosePosition& front()
    {
        return positions[start];
    }

    SClosePosition& operator[](int index)
    {
